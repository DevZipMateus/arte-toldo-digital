...
const Contact = () => {
  ...
  return (
    <section id="contato" className="py-20 bg-arte-gray-light">
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {contactInfo.map((info, index) => (
                <Card key={index} className="p-6 hover:shadow-lg transition-all duration-300 border-0 arte-shadow-soft">
                    ...
                    <div className="flex-1">
                      ...
                      {info.link && info.action && (
                        <Button 
                          variant="outline" 
                          size="sm"
                          className="border-arte-blue-royal text-arte-blue-royal hover:bg-arte-blue-royal hover:text-white"
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 border-0 arte-shadow-soft">
              ...
              <div className="aspect-video rounded-lg overflow-hidden bg-arte-gray-light">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3943.1234567890123!2d-63.87654321!3d-8.76543210!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOMKwNDUnNTEuNiJTIDYzwrA1Mic0Ny41Ilc!5e0!3m2!1spt-BR!2sbr!4v1234567890123!5m2!1spt-BR!2sbr"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Localização da Arte Toldo"
                ></iframe>
              </div>
              <Button 
                variant="outline" 
                className="w-full mt-4 border-arte-blue-royal text-arte-blue-royal hover:bg-arte-blue-royal hover:text-white"
                onClick={() => window.open('https://share.google/5aivFj5AS0SQsAMkg', '_blank')}
              >
